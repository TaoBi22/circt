...
### The dummies subdialect

The `axi4.dummies` types and operations describe a network structurally, leaving
much of the information in the main dialect's type system to be inferred. This
is intended to be used as or in a front-end.
