...
// A network living inside an hw.module lowers in place: the instances are
// emitted into that module's body, between its ports and its terminator, rather
// than at the top level.

// CHECK-LABEL: hw.module @AXITop(in %clk_i : i1, in %rst_ni : i1) {
// CHECK: hw.instance "mgr_module{{.*}}" @mgr_module
// CHECK: hw.instance "sub_module{{.*}}" @sub_module
// CHECK: hw.output
...
hw.module @AXITop(in %clk_i : i1, in %rst_ni : i1) {
