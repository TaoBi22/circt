...
hw.module @DummiesXbar(in %clk : !seq.clock, in %rst_ni : i1) {
  ...
  // CHECK: axi4.dummies.ext_subordinate %clk, %rst_ni, %[[XBAR]] windows <<base = 0x0, last = 0xfff, burst_specs = <<incr, len = 16>>>>
  ...
  // CHECK: axi4.dummies.ext_subordinate %clk, %rst_ni, %[[XBAR]] windows <<base = 0x1000, last = 0x1fff, burst_specs = <<fixed, len = 4>>>>
