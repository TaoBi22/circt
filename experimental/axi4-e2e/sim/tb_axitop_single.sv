...
module tb_axitop_single;
  ...
  initial begin
    ...
    if (!seen_done) begin
      ...
      $fatal;
    end else if (dut.mgr.beat0 !== EXPECTED_BEAT0 ||
                 dut.mgr.beat1 !== EXPECTED_BEAT1 ||
                 dut.mgr.beat2 !== EXPECTED_BEAT2 ||
                 dut.mgr.beat3 !== EXPECTED_BEAT3) begin
      $display("FAIL: first read burst mismatch: beats=%0h,%0h,%0h,%0h != expected %0h,%0h,%0h,%0h",
                dut.mgr.beat0, dut.mgr.beat1,
                dut.mgr.beat2, dut.mgr.beat3,
                EXPECTED_BEAT0, EXPECTED_BEAT1, EXPECTED_BEAT2, EXPECTED_BEAT3);
      $fatal;
    end else if (dut.mgr.after_beat0 !== EXPECTED_BEAT0 ||
                 dut.mgr.after_beat1 !== NEW_WORD1 ||
                 dut.mgr.after_beat2 !== NEW_WORD2 ||
                 dut.mgr.after_beat3 !== EXPECTED_BEAT3) begin
      $display("FAIL: read-after-write mismatch: after_beats=%0h,%0h,%0h,%0h != expected %0h,%0h,%0h,%0h",
                dut.mgr.after_beat0, dut.mgr.after_beat1,
                dut.mgr.after_beat2, dut.mgr.after_beat3,
