...
module tb_axitop_mixed_fanout;
  ...
  initial begin
    ...
    if (!seen_done) begin
      ...
      $fatal;
    end else if (dut.mgr.a_beat0 !== EXPECTED_A_BEAT0 ||
                 dut.mgr.a_beat1 !== EXPECTED_A_BEAT1 ||
                 dut.mgr.a_beat2 !== EXPECTED_A_BEAT2 ||
                 dut.mgr.a_beat3 !== EXPECTED_A_BEAT3 ||
                 dut.mgr.b_beat0 !== EXPECTED_B_BEAT0 ||
                 dut.mgr.b_beat1 !== EXPECTED_B_BEAT1 ||
                 dut.mgr.b_beat2 !== EXPECTED_B_BEAT2 ||
                 dut.mgr.b_beat3 !== EXPECTED_B_BEAT3) begin
      $display("FAIL: first read burst mismatch");
      $display("  burst A (direct via xbar1): %0h,%0h,%0h,%0h",
                dut.mgr.a_beat0, dut.mgr.a_beat1,
                dut.mgr.a_beat2, dut.mgr.a_beat3);
      $display("  burst B (chained via xbar2): %0h,%0h,%0h,%0h",
                dut.mgr.b_beat0, dut.mgr.b_beat1,
                dut.mgr.b_beat2, dut.mgr.b_beat3);
      $fatal;
    end else if (dut.mgr.after_a_beat0 !== EXPECTED_A_BEAT0 ||
                 dut.mgr.after_a_beat1 !== NEW_A_WORD1 ||
                 dut.mgr.after_a_beat2 !== NEW_A_WORD2 ||
                 dut.mgr.after_a_beat3 !== EXPECTED_A_BEAT3 ||
                 dut.mgr.after_b_beat0 !== EXPECTED_B_BEAT0 ||
                 dut.mgr.after_b_beat1 !== NEW_B_WORD1 ||
                 dut.mgr.after_b_beat2 !== NEW_B_WORD2 ||
                 dut.mgr.after_b_beat3 !== EXPECTED_B_BEAT3) begin
      $display("FAIL: read-after-write mismatch");
      $display("  burst A after: %0h,%0h,%0h,%0h",
                dut.mgr.after_a_beat0, dut.mgr.after_a_beat1,
                dut.mgr.after_a_beat2, dut.mgr.after_a_beat3);
      $display("  burst B after: %0h,%0h,%0h,%0h",
                dut.mgr.after_b_beat0, dut.mgr.after_b_beat1,
                dut.mgr.after_b_beat2, dut.mgr.after_b_beat3);
      $fatal;
    end else begin
