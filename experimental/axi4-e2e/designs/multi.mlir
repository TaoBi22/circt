// 2 managers -> xbar -> 2 subordinates, inside a top module. Emits AXITop + one
// axi_xbar_2u2d wrapper with a two-rule address map. Two managers widen the
// downstream id 4 -> 5.
