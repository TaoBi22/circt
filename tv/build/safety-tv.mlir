module {
  ...
  func.func @fsm10() {
    ...
    %2 = smt.solver() : () -> i1 {
      ...
      %5:7 = scf.for %arg0 = %c0_i32 to %c3_i32 step %c1_i32 iter_args(%arg1 = %input_0, %arg2 = %4, %arg3 = %input_2, %arg4 = %c0_bv4, %arg5 = %c0_bv16, %arg6 = %c0_bv8, %arg7 = %true) -> (!smt.bv<1>, !smt.bv<1>, !smt.bv<1>, !smt.bv<4>, !smt.bv<16>, !smt.bv<8>, i1)  : i32 {
        smt.pop 1
        smt.push 1
...
%equivalence_check_0 = smt.eq %obsarg1, %arg0 : !smt.bv<1>
