module {
  ...
  func.func @fsm50() {
    ...
    %2 = smt.solver() : () -> i1 {
      ...
      %5:6 = scf.for %arg0 = %c0_i32 to %c10_i32 step %c1_i32 iter_args(%arg1 = %4, %arg2 = %input_1, %arg3 = %c0_bv6, %arg4 = %c0_bv16, %arg5 = %c0_bv8, %arg6 = %true) -> (!smt.bv<1>, !smt.bv<1>, !smt.bv<6>, !smt.bv<16>, !smt.bv<8>, i1)  : i32 {
        smt.pop 1
        smt.push 1
...
llvm.mlir.global private constant @unsatString("unsat\0A\00") {addr_space = 0 : i32}
  ...
  func.func @bmc_circuit(%arg0: !smt.bv<1>, %arg1: !smt.bv<1>, %arg2: !smt.bv<6>, %arg3: !smt.bv<16>, %arg4: !smt.bv<8>) -> (!smt.bv<6>, !smt.bv<16>, !smt.bv<8>) {
    ...
    ^bb0(%obsarg0: !smt.bv<16>, %obsarg1: !smt.bv<8>):
      ...
      %obs55 = smt.implies %obs51, %obs54
      smt.yield %obs55 : !smt.bool
    }
    smt.assert %obs1
    %obs2 = smt.forall {
    ^bb0(%obsarg0: !smt.bv<16>, %obsarg1: !smt.bv<8>):
