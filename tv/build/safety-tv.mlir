module {
  ...
  func.func @fsm10() {
    ...
    %2 = smt.solver() : () -> i1 {
      ...
      %7 = smt.declare_fun : !smt.bv<4>
      %8 = smt.declare_fun : !smt.bv<16>
      %9 = smt.declare_fun : !smt.bv<32>
      %10:7 = scf.for %arg0 = %c0_i32 to %c20_i32 step %c1_i32 iter_args(%arg1 = %5, %arg2 = %4, %arg3 = %6, %arg4 = %7, %arg5 = %8, %arg6 = %9, %arg7 = %false) -> (!smt.bv<1>, !smt.bv<1>, !smt.bv<1>, !smt.bv<4>, !smt.bv<16>, !smt.bv<32>, i1)  : i32 {
        smt.pop 1
        smt.push 1
        %12:3 = func.call @bmc_circuit(%arg1, %arg2, %arg3, %arg4, %arg5, %arg6) : (!smt.bv<1>, !smt.bv<1>, !smt.bv<1>, !smt.bv<4>, !smt.bv<16>, !smt.bv<32>) -> (!smt.bv<4>, !smt.bv<16>, !smt.bv<32>)
        %13 = smt.check sat {
          smt.yield %true : i1
        } unknown {
          smt.yield %true : i1
...
%string = llvm.select %13, %ss, %us : i1, !llvm.ptr
llvm.call @printf(%string) vararg(!llvm.func<void (ptr, ...)>) : (!llvm.ptr) -> ()
        %14 = arith.ori %13, %arg7 : i1
        %15 = func.call @bmc_loop(%arg2) : (!smt.bv<1>) -> !smt.bv<1>
        %16 = smt.declare_fun : !smt.bv<1>
        %17 = smt.declare_fun : !smt.bv<1>
        %18 = smt.bv.not %arg2 : !smt.bv<1>
        %19 = smt.bv.and %18, %15 : !smt.bv<1>
        %20 = smt.eq %19, %c-1_bv1 : !smt.bv<1>
        %21 = smt.ite %20, %12#0, %arg4 : !smt.bv<4>
        %22 = smt.ite %20, %12#1, %arg5 : !smt.bv<16>
        %23 = smt.ite %20, %12#2, %arg6 : !smt.bv<32>
        scf.yield %16, %15, %17, %21, %22, %23, %14 : !smt.bv<1>, !smt.bv<1>, !smt.bv<1>, !smt.bv<4>, !smt.bv<16>, !smt.bv<32>, i1
      }
      %11 = arith.xori %10#6, %true : i1
      smt.yield %11 : i1
    }
...
^bb0(%input_0: !smt.bool, %var_0: !smt.bv<16>, %rtlTime: !smt.bv<32>):
...
%apply = smt.apply_func %obsF__0(%input_0, %var_0_int, %rtlTime_int) : !smt.func<(!smt.bool, !smt.int, !smt.int) !smt.bool>
%rightTime = smt.eq %rtlTime, %arg5 : !smt.bv<32>
%antecedent = smt.and %apply, %rightTime
%var_0_eq = smt.eq %var_0, %arg4 : !smt.bv<16>
...
%rtlTime_int = smt.bv2int %rtlTime : !smt.bv<32>
%apply = smt.apply_func %obsF__1(%input_0, %var_0_int, %rtlTime_int) : !smt.func<(!smt.bool, !smt.int, !smt.int) !smt.bool>
%rightTime = smt.eq %rtlTime, %arg5 : !smt.bv<32>
%antecedent = smt.and %apply, %rightTime
%var_0_eq = smt.eq %var_0, %arg4 : !smt.bv<16>
%impl = smt.implies %antecedent, %var_0_eq
...
%rtlTime_int = smt.bv2int %rtlTime : !smt.bv<32>
%apply = smt.apply_func %obsF__2(%input_0, %var_0_int, %rtlTime_int) : !smt.func<(!smt.bool, !smt.int, !smt.int) !smt.bool>
%rightTime = smt.eq %rtlTime, %arg5 : !smt.bv<32>
%antecedent = smt.and %apply, %rightTime
%var_0_eq = smt.eq %var_0, %arg4 : !smt.bv<16>
%impl = smt.implies %antecedent, %var_0_eq
...
%rtlTime_int = smt.bv2int %rtlTime : !smt.bv<32>
%apply = smt.apply_func %obsF__3(%input_0, %var_0_int, %rtlTime_int) : !smt.func<(!smt.bool, !smt.int, !smt.int) !smt.bool>
%rightTime = smt.eq %rtlTime, %arg5 : !smt.bv<32>
%antecedent = smt.and %apply, %rightTime
%var_0_eq = smt.eq %var_0, %arg4 : !smt.bv<16>
%impl = smt.implies %antecedent, %var_0_eq
...
%rtlTime_int = smt.bv2int %rtlTime : !smt.bv<32>
%apply = smt.apply_func %obsF__4(%input_0, %var_0_int, %rtlTime_int) : !smt.func<(!smt.bool, !smt.int, !smt.int) !smt.bool>
%rightTime = smt.eq %rtlTime, %arg5 : !smt.bv<32>
%antecedent = smt.and %apply, %rightTime
%var_0_eq = smt.eq %var_0, %arg4 : !smt.bv<16>
%impl = smt.implies %antecedent, %var_0_eq
...
%rtlTime_int = smt.bv2int %rtlTime : !smt.bv<32>
%apply = smt.apply_func %obsF__5(%input_0, %var_0_int, %rtlTime_int) : !smt.func<(!smt.bool, !smt.int, !smt.int) !smt.bool>
%rightTime = smt.eq %rtlTime, %arg5 : !smt.bv<32>
%antecedent = smt.and %apply, %rightTime
%var_0_eq = smt.eq %var_0, %arg4 : !smt.bv<16>
%impl = smt.implies %antecedent, %var_0_eq
...
%rtlTime_int = smt.bv2int %rtlTime : !smt.bv<32>
%apply = smt.apply_func %obsF__6(%input_0, %var_0_int, %rtlTime_int) : !smt.func<(!smt.bool, !smt.int, !smt.int) !smt.bool>
%rightTime = smt.eq %rtlTime, %arg5 : !smt.bv<32>
%antecedent = smt.and %apply, %rightTime
%var_0_eq = smt.eq %var_0, %arg4 : !smt.bv<16>
%impl = smt.implies %antecedent, %var_0_eq
...
%rtlTime_int = smt.bv2int %rtlTime : !smt.bv<32>
%apply = smt.apply_func %obsF__7(%input_0, %var_0_int, %rtlTime_int) : !smt.func<(!smt.bool, !smt.int, !smt.int) !smt.bool>
%rightTime = smt.eq %rtlTime, %arg5 : !smt.bv<32>
%antecedent = smt.and %apply, %rightTime
%var_0_eq = smt.eq %var_0, %arg4 : !smt.bv<16>
%impl = smt.implies %antecedent, %var_0_eq
...
%rtlTime_int = smt.bv2int %rtlTime : !smt.bv<32>
%apply = smt.apply_func %obsF__8(%input_0, %var_0_int, %rtlTime_int) : !smt.func<(!smt.bool, !smt.int, !smt.int) !smt.bool>
%rightTime = smt.eq %rtlTime, %arg5 : !smt.bv<32>
%antecedent = smt.and %apply, %rightTime
%var_0_eq = smt.eq %var_0, %arg4 : !smt.bv<16>
%impl = smt.implies %antecedent, %var_0_eq
...
%rtlTime_int = smt.bv2int %rtlTime : !smt.bv<32>
%apply = smt.apply_func %obsF__9(%input_0, %var_0_int, %rtlTime_int) : !smt.func<(!smt.bool, !smt.int, !smt.int) !smt.bool>
%rightTime = smt.eq %rtlTime, %arg5 : !smt.bv<32>
%antecedent = smt.and %apply, %rightTime
%var_0_eq = smt.eq %var_0, %arg4 : !smt.bv<16>
%impl = smt.implies %antecedent, %var_0_eq
...
%rtlTime_int = smt.bv2int %rtlTime : !smt.bv<32>
%apply = smt.apply_func %obsF__10(%input_0, %var_0_int, %rtlTime_int) : !smt.func<(!smt.bool, !smt.int, !smt.int) !smt.bool>
%rightTime = smt.eq %rtlTime, %arg5 : !smt.bv<32>
%antecedent = smt.and %apply, %rightTime
%var_0_eq = smt.eq %var_0, %arg4 : !smt.bv<16>
%impl = smt.implies %antecedent, %var_0_eq
...
%rtlTime_int = smt.bv2int %rtlTime : !smt.bv<32>
%apply = smt.apply_func %obsF_ERR(%input_0, %var_0_int, %rtlTime_int) : !smt.func<(!smt.bool, !smt.int, !smt.int) !smt.bool>
%rightTime = smt.eq %rtlTime, %arg5 : !smt.bv<32>
%antecedent = smt.and %apply, %rightTime
%var_0_eq = smt.eq %var_0, %arg4 : !smt.bv<16>
%impl = smt.implies %antecedent, %var_0_eq
...
%desired_input_0 = smt.apply_func %input_0_func(%arg5) : !smt.func<(!smt.bv<32>) !smt.bv<1>>
%input_0_eq = smt.eq %desired_input_0, %arg0 : !smt.bv<1>
smt.assert %input_0_eq
%tvclause_input_0 = smt.forall{
^bb0(%time: !smt.bv<32>):
%input_val = smt.apply_func %input_0_func(%time) : !smt.func<(!smt.bv<32>) !smt.bv<1>>
%input_eq = smt.eq %input_val, %arg0 : !smt.bv<1>
smt.yield %input_eq : !smt.bool
}
smt.assert %tvclause_input_0
