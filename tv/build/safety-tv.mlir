module {
  ...
  func.func @fsm10() {
    ...
    %2 = smt.solver() : () -> i1 {
      ...
      %5:6 = scf.for %arg0 = %c0_i32 to %c5_i32 step %c1_i32 iter_args(%arg1 = %4, %arg2 = %input_1, %arg3 = %c0_bv4, %arg4 = %c0_bv16, %arg5 = %c0_bv8, %arg6 = %true) -> (!smt.bv<1>, !smt.bv<1>, !smt.bv<4>, !smt.bv<16>, !smt.bv<8>, i1)  : i32 {
        smt.pop 1
        smt.push 1
        %7:3 = func.call @bmc_circuit(%arg1, %arg2, %arg3, %arg4, %arg5) : (!smt.bv<1>, !smt.bv<1>, !smt.bv<4>, !smt.bv<16>, !smt.bv<8>) -> (!smt.bv<4>, !smt.bv<16>, !smt.bv<8>)
        %8 = smt.check sat {
          smt.yield %true : i1
        } unknown {
          smt.yield %true : i1
...
llvm.call @printf(%string) vararg(!llvm.func<void (ptr, ...)>) : (!llvm.ptr) -> ()
        ...
        scf.yield %10, %input_1_0, %7#0, %7#1, %7#2, %9 : !smt.bv<1>, !smt.bv<1>, !smt.bv<4>, !smt.bv<16>, !smt.bv<8>, i1
      }
...
llvm.mlir.global private constant @unsatString("unsat\0A\00") {addr_space = 0 : i32}
  ...
  func.func @bmc_circuit(%arg0: !smt.bv<1>, %arg1: !smt.bv<1>, %arg2: !smt.bv<4>, %arg3: !smt.bv<16>, %arg4: !smt.bv<8>) -> (!smt.bv<4>, !smt.bv<16>, !smt.bv<8>) {
    ...
    %74 = smt.bv.add %arg4, %c1_bv8 : !smt.bv<8>
    %75 = smt.eq %arg1, %c-1_bv1 : !smt.bv<1>
    %76 = smt.ite %75, %c0_bv4, %73 : !smt.bv<4>
    %77 = smt.eq %arg1, %c-1_bv1 : !smt.bv<1>
    %78 = smt.ite %77, %c0_bv16, %67 : !smt.bv<16>
    ...
    ^bb0(%obsarg0: !smt.bv<16>, %obsarg1: !smt.bv<8>):
      ...
      %obs11 = smt.apply_func %obsF__0(%obsc0_bv16_0, %obsc0_bv8) : !smt.func<(!smt.bv<16>, !smt.bv<8>) !smt.bool>
      smt.yield %obs11 : !smt.bool
    }
    smt.assert %obs0
    %obs1 = smt.forall {
    ^bb0(%obsarg0: !smt.bv<16>, %obsarg1: !smt.bv<8>):
      %obs11 = smt.apply_func %obsF__0(%obsarg0, %obsarg1) : !smt.func<(!smt.bv<16>, !smt.bv<8>) !smt.bool>
      %obs12 = smt.bv.add %obsarg0, %obsc1_bv16 : !smt.bv<16>
      %obsc1_bv8 = smt.bv.constant #smt.bv<1> : !smt.bv<8>
      %obs13 = smt.bv.add %obsarg1, %obsc1_bv8 : !smt.bv<8>
      %obs14 = smt.apply_func %obsF__1(%obs12, %obs13) : !smt.func<(!smt.bv<16>, !smt.bv<8>) !smt.bool>
    ...
    %obs2 = smt.forall {
    ^bb0(%obsarg0: !smt.bv<16>, %obsarg1: !smt.bv<8>):
      %obs11 = smt.apply_func %obsF__1(%obsarg0, %obsarg1) : !smt.func<(!smt.bv<16>, !smt.bv<8>) !smt.bool>
      %obs12 = smt.bv.add %obsarg0, %obsc1_bv16 : !smt.bv<16>
      %obsc1_bv8 = smt.bv.constant #smt.bv<1> : !smt.bv<8>
      %obs13 = smt.bv.add %obsarg1, %obsc1_bv8 : !smt.bv<8>
      %obs14 = smt.apply_func %obsF__2(%obs12, %obs13) : !smt.func<(!smt.bv<16>, !smt.bv<8>) !smt.bool>
      %obstrue = smt.constant true
      %obs15 = smt.and %obs11, %obstrue
      %obs16 = smt.implies %obs15, %obs14
      smt.yield %obs16 : !smt.bool
    ...
    %obs3 = smt.forall {
    ^bb0(%obsarg0: !smt.bv<16>, %obsarg1: !smt.bv<8>):
      %obs11 = smt.apply_func %obsF__2(%obsarg0, %obsarg1) : !smt.func<(!smt.bv<16>, !smt.bv<8>) !smt.bool>
      %obs12 = smt.bv.add %obsarg0, %obsc1_bv16 : !smt.bv<16>
      %obsc1_bv8 = smt.bv.constant #smt.bv<1> : !smt.bv<8>
      %obs13 = smt.bv.add %obsarg1, %obsc1_bv8 : !smt.bv<8>
      %obs14 = smt.apply_func %obsF__3(%obs12, %obs13) : !smt.func<(!smt.bv<16>, !smt.bv<8>) !smt.bool>
      %obstrue = smt.constant true
      %obs15 = smt.and %obs11, %obstrue
      %obs16 = smt.implies %obs15, %obs14
      smt.yield %obs16 : !smt.bool
    ...
    %obs4 = smt.forall {
    ^bb0(%obsarg0: !smt.bv<16>, %obsarg1: !smt.bv<8>):
      %obs11 = smt.apply_func %obsF__3(%obsarg0, %obsarg1) : !smt.func<(!smt.bv<16>, !smt.bv<8>) !smt.bool>
      %obs12 = smt.bv.add %obsarg0, %obsc1_bv16 : !smt.bv<16>
      %obsc1_bv8 = smt.bv.constant #smt.bv<1> : !smt.bv<8>
      %obs13 = smt.bv.add %obsarg1, %obsc1_bv8 : !smt.bv<8>
      %obs14 = smt.apply_func %obsF__4(%obs12, %obs13) : !smt.func<(!smt.bv<16>, !smt.bv<8>) !smt.bool>
      %obstrue = smt.constant true
      %obs15 = smt.and %obs11, %obstrue
      %obs16 = smt.implies %obs15, %obs14
      smt.yield %obs16 : !smt.bool
    ...
    %obs5 = smt.forall {
    ^bb0(%obsarg0: !smt.bv<16>, %obsarg1: !smt.bv<8>):
      %obs11 = smt.apply_func %obsF__4(%obsarg0, %obsarg1) : !smt.func<(!smt.bv<16>, !smt.bv<8>) !smt.bool>
      %obs12 = smt.bv.add %obsarg0, %obsc1_bv16 : !smt.bv<16>
      %obsc1_bv8 = smt.bv.constant #smt.bv<1> : !smt.bv<8>
      %obs13 = smt.bv.add %obsarg1, %obsc1_bv8 : !smt.bv<8>
      %obs14 = smt.apply_func %obsF__5(%obs12, %obs13) : !smt.func<(!smt.bv<16>, !smt.bv<8>) !smt.bool>
      %obstrue = smt.constant true
      %obs15 = smt.and %obs11, %obstrue
      %obs16 = smt.implies %obs15, %obs14
      smt.yield %obs16 : !smt.bool
    ...
    %obs6 = smt.forall {
    ^bb0(%obsarg0: !smt.bv<16>, %obsarg1: !smt.bv<8>):
      %obs11 = smt.apply_func %obsF__5(%obsarg0, %obsarg1) : !smt.func<(!smt.bv<16>, !smt.bv<8>) !smt.bool>
      %obs12 = smt.bv.add %obsarg0, %obsc1_bv16 : !smt.bv<16>
      %obsc1_bv8 = smt.bv.constant #smt.bv<1> : !smt.bv<8>
      %obs13 = smt.bv.add %obsarg1, %obsc1_bv8 : !smt.bv<8>
      %obs14 = smt.apply_func %obsF__6(%obs12, %obs13) : !smt.func<(!smt.bv<16>, !smt.bv<8>) !smt.bool>
      %obstrue = smt.constant true
      %obs15 = smt.and %obs11, %obstrue
      %obs16 = smt.implies %obs15, %obs14
      smt.yield %obs16 : !smt.bool
    ...
    %obs7 = smt.forall {
    ^bb0(%obsarg0: !smt.bv<16>, %obsarg1: !smt.bv<8>):
      %obs11 = smt.apply_func %obsF__6(%obsarg0, %obsarg1) : !smt.func<(!smt.bv<16>, !smt.bv<8>) !smt.bool>
      %obs12 = smt.bv.add %obsarg0, %obsc1_bv16 : !smt.bv<16>
      %obsc1_bv8 = smt.bv.constant #smt.bv<1> : !smt.bv<8>
      %obs13 = smt.bv.add %obsarg1, %obsc1_bv8 : !smt.bv<8>
      %obs14 = smt.apply_func %obsF__7(%obs12, %obs13) : !smt.func<(!smt.bv<16>, !smt.bv<8>) !smt.bool>
      %obstrue = smt.constant true
      %obs15 = smt.and %obs11, %obstrue
      %obs16 = smt.implies %obs15, %obs14
      smt.yield %obs16 : !smt.bool
    ...
    %obs8 = smt.forall {
    ^bb0(%obsarg0: !smt.bv<16>, %obsarg1: !smt.bv<8>):
      %obs11 = smt.apply_func %obsF__7(%obsarg0, %obsarg1) : !smt.func<(!smt.bv<16>, !smt.bv<8>) !smt.bool>
      %obs12 = smt.bv.add %obsarg0, %obsc1_bv16 : !smt.bv<16>
      %obsc1_bv8 = smt.bv.constant #smt.bv<1> : !smt.bv<8>
      %obs13 = smt.bv.add %obsarg1, %obsc1_bv8 : !smt.bv<8>
      %obs14 = smt.apply_func %obsF__8(%obs12, %obs13) : !smt.func<(!smt.bv<16>, !smt.bv<8>) !smt.bool>
      %obstrue = smt.constant true
      %obs15 = smt.and %obs11, %obstrue
      %obs16 = smt.implies %obs15, %obs14
      smt.yield %obs16 : !smt.bool
    ...
    %obs9 = smt.forall {
    ^bb0(%obsarg0: !smt.bv<16>, %obsarg1: !smt.bv<8>):
      %obs11 = smt.apply_func %obsF__8(%obsarg0, %obsarg1) : !smt.func<(!smt.bv<16>, !smt.bv<8>) !smt.bool>
      %obs12 = smt.bv.add %obsarg0, %obsc1_bv16 : !smt.bv<16>
      %obsc1_bv8 = smt.bv.constant #smt.bv<1> : !smt.bv<8>
      %obs13 = smt.bv.add %obsarg1, %obsc1_bv8 : !smt.bv<8>
      %obs14 = smt.apply_func %obsF__9(%obs12, %obs13) : !smt.func<(!smt.bv<16>, !smt.bv<8>) !smt.bool>
      %obstrue = smt.constant true
      %obs15 = smt.and %obs11, %obstrue
      %obs16 = smt.implies %obs15, %obs14
      smt.yield %obs16 : !smt.bool
    ...
    %obs10 = smt.forall {
    ^bb0(%obsarg0: !smt.bv<16>, %obsarg1: !smt.bv<8>):
      %obs11 = smt.apply_func %obsF__9(%obsarg0, %obsarg1) : !smt.func<(!smt.bv<16>, !smt.bv<8>) !smt.bool>
      %obs12 = smt.bv.add %obsarg0, %obsc1_bv16 : !smt.bv<16>
      %obsc1_bv8 = smt.bv.constant #smt.bv<1> : !smt.bv<8>
      %obs13 = smt.bv.add %obsarg1, %obsc1_bv8 : !smt.bv<8>
      %obs14 = smt.apply_func %obsF__10(%obs12, %obs13) : !smt.func<(!smt.bv<16>, !smt.bv<8>) !smt.bool>
      %obstrue = smt.constant true
      %obs15 = smt.and %obs11, %obstrue
      %obs16 = smt.implies %obs15, %obs14
      smt.yield %obs16 : !smt.bool
...
smt.assert %tvclause_10
    return %76, %78, %74 : !smt.bv<4>, !smt.bv<16>, !smt.bv<8>
  }
}
