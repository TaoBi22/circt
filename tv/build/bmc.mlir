module {
  ...
  func.func @fsm50() {
    ...
    %2 = smt.solver() : () -> i1 {
      ...
      %5:6 = scf.for %arg0 = %c0_i32 to %c50_i32 step %c1_i32 iter_args(%arg1 = %4, %arg2 = %input_1, %arg3 = %c0_bv6, %arg4 = %c0_bv16, %arg5 = %c0_bv8, %arg6 = %false) -> (!smt.bv<1>, !smt.bv<1>, !smt.bv<6>, !smt.bv<16>, !smt.bv<8>, i1)  : i32 {
        smt.pop 1
        smt.push 1
