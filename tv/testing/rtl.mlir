module {
  hw.module @fsm10(in %clk : !seq.clock, in %rst : i1) {
    ...
    %state_reg = seq.compreg sym @state_reg %41, %clk initial %init : i4
    %c0_i16 = hw.constant 0 : i16
    %init16 = seq.initial() {
      %c0_i4_0 = hw.constant 0 : i16
      seq.yield %c0_i4_0 : i16
    } : () -> !seq.immutable<i16>
    %x0 = seq.compreg sym @x0 %38, %clk initial %init16 : i16  
    ...
    %init32 = seq.initial() {
      %c0_i4_0 = hw.constant 0 : i32
      seq.yield %c0_i4_0 : i32
    } : () -> !seq.immutable<i32>
    %time_reg = seq.compreg sym @time_reg %added, %clk initial %init32 : i32
