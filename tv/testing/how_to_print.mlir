module {
  ...
  llvm.func @fsm10() {
    ...
    %m = llvm.call @Z3_solver_get_model(%3, %5) : (!llvm.ptr, !llvm.ptr) -> !llvm.ptr
    %s = llvm.call @Z3_model_to_string(%3, %m) : (!llvm.ptr, !llvm.ptr) -> !llvm.ptr
    llvm.call @printf(%s) vararg(!llvm.func<void (ptr, ...)>) : (!llvm.ptr) -> ()
  ...
  ^bb10:  // pred: ^bb9
    ...
    %49 = llvm.or %46, %30  : i1
    %50 = llvm.call @bmc_loop(%25) : (!llvm.ptr) -> !llvm.ptr
    %51 = llvm.mlir.zero : !llvm.ptr
    %52 = llvm.mlir.constant(1 : i32) : i32
    %53 = llvm.call @Z3_mk_bv_sort(%48, %52) : (!llvm.ptr, i32) -> !llvm.ptr
    %54 = llvm.call @Z3_mk_fresh_const(%48, %51, %53) : (!llvm.ptr, !llvm.ptr, !llvm.ptr) -> !llvm.ptr
    %55 = llvm.add %24, %5 : i32
    llvm.br ^bb1(%55, %50, %54, %37, %38, %39, %49 : i32, !llvm.ptr, !llvm.ptr, !llvm.ptr, !llvm.ptr, !llvm.ptr, i1)
  ^bb11:  // pred: ^bb1
    %56 = llvm.xor %30, %2  : i1
    llvm.return %56 : i1
  }
